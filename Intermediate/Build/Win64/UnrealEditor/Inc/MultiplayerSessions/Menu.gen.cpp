...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//\n// Callbacks for the custom delegates on the MultiplayeSessionsSubsystem\n//\n" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "Callbacks for the custom delegates on the MultiplayeSessionsSubsystem" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 402867678
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1520599822U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_57875328(TEXT("/Script/MultiplayerSessions"),
